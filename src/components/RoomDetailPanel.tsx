      ...
      {room && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 bottom-0 z-[70] w-full sm:max-w-md bg-white dark:bg-[#0f0f0f] shadow-2xl flex flex-col overflow-hidden border-l border-gray-100 dark:border-white/5"
          >
            {/* Header */}
